...
class Config(object):
    API_ID = int(os.getenv("API_ID", "27600849"))
    API_HASH = os.getenv("API_HASH", "c6f6d585ee511e7a7a5f03a61a8ef376")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "7709250858:AAHmzJ9SfY7t7WW9X_J0N4RYXRgiLpDoxM0")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "moviedolowerbot")
    USER_SESSION_STRING = os.getenv("USER_SESSION_STRING", "String")
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001770767843")) 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "@MovieflixDownloader_bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5787491310"))
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001516486108")
    DATABASE_URL = os.getenv("DATABASE_URL", "18c3fac0004d926f9760076341759f3bb01463981e82f7fda580f518c5079b52")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1002395667437"))
    RESULTS_COUNT = int(os.getenv("RESULTS_COUNT", 20))
    BROADCAST_AS_COPY = os.getenv("BROADCAST_AS_COPY", "True")
    UPDATES_CHANNEL_USERNAME = os.getenv("UPDATES_CHANNEL_USERNAME", "https://t.me/downloadhubvideo")
